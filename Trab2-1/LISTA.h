...
*     Implementa listas duplamente encadeadas.
...
*     Os possíveis tipos são caracteres.
...
*     pValor - ponteiro para o valor de caracter(es) do novo elemento
*              Pode ser NULL
*
*  $FV Valor retornado
*     LIS_CondRetOK
...
*
*  $ED Descrição da função
*     Procura o elemento que referencia o valor de caracter(es) dado.
*     A função compara ponteiro e não conteúdo apontado.
*
*  $EP Parâmetros
*     pLista  - ponteiro para a lista onde procura
*     pValor  - ponteiro para o valor de caracter(es) procurado
*               Pode ser NULL
*
*  $FV Valor retornado
